...
import 'package:med/core/features/etudiant/domain/usecases/getetudiant_usecase.dart';
import 'package:med/core/features/etudiant/domain/usecases/update_photo_usecase.dart';
...
final updateProfilePictureProvider =
    FutureProvider.family<Either<Failure, String>, Map<String, String>>(
        (ref, data) async {
  final useCase = ref.read(updateProfilePictureUseCaseProvider);
  return await useCase(data['studentId']!, data['photoUrl']!);
});
...
final sidebarSelectedIndexProvider = StateProvider<int>((ref) => 4);
